...
public class BagListAdapterAlt extends BaseAdapter {
    ...
    public BagListAdapterAlt(Activity context, List<BagItemModel> bagList, BagViewModel vm) {
        this.context = context;
        this.bagList = bagList;
        this.vm = vm;
    }

    public BagListAdapterAlt(Activity context, List<BagItemModel> bagList, Boolean isPlain) {
        this.context = context;
        this.bagList = bagList;
